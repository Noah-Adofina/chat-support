...
export default function Home() {
  const [messages, setMessages] = useState([
    {
      role: "assistant", 
      content: "Hello! Welcome to Headstarter's customer support. How can I assist you today?",
    },
  ])
  ...
  return (
    ...
    >
      <Stack direction={'column'} width={'500px'} height={'700px'} border={'1px solid #000'} p={2} spacing={3}>
        ...
        <Stack direction={'row'} spacing={2} p={1} display={'flex'} justifyContent={'center'} alignItems={'center'}>
          <TextField 
            label='Message' 
            fullWidth
            value={message}
